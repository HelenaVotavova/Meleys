# Lenčin přehled pro Android

Domovský widget s Lenčiným rozvrhem. Přihlášení probíhá přímo na webu EduPage v aplikaci; heslo aplikace nečte ani neukládá. Šifrovaně se ukládá pouze přihlašovací cookie.
