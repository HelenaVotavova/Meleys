...
static void repaint(void){
 ...
 {int by=995, bh=ScreenHeight()-by-30; if(bh>110){DrawRect(35,by,w-70,bh,BLACK);text(65,by+20,w-130,48,"CO SI VZIT NA SEBE",body,ALIGN_LEFT);text(65,by+78,w-130,bh-95,rec,advice,ALIGN_CENTER|VALIGN_MIDDLE);}}
 FullUpdate();
}
